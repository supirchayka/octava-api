...
async function adminCatalogRoutes(app) {
    const controller = new admin_catalog_controller_1.AdminCatalogController(app);
    /* ========== Общие куски схемы ========== */
    const seoSchema = {
        type: 'object',
    ...
    /* ========== Categories ========== */
    app.post('/admin/catalog/categories', {
    ...
    app.put('/admin/catalog/categories/:id', {
        preHandler: [app.authenticate],
        schema: {
            params: {
                type: 'object',
    ...
    /* ========== Services ========== */
    app.post('/admin/catalog/services', {
        preHandler: [app.authenticate],
        schema: {
            body: {
                type: 'object',
    ...
    app.put('/admin/catalog/services/:id', {
        preHandler: [app.authenticate],
        schema: {
            params: {
                type: 'object',
    ...
    app.delete('/admin/catalog/services/:id', {
        preHandler: [app.authenticate],
        schema: {
            params: {
                type: 'object',
    ...
    /* ========== Devices ========== */
    app.post('/admin/catalog/devices', {
        preHandler: [app.authenticate],
        schema: {
            body: {
                type: 'object',
    ...
    app.put('/admin/catalog/devices/:id', {
        preHandler: [app.authenticate],
        schema: {
            params: {
                type: 'object',
    ...
    app.delete('/admin/catalog/devices/:id', {
        preHandler: [app.authenticate],
        schema: {
            params: {
                type: 'object',
