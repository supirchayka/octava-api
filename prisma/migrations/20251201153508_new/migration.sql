...
-- AddForeignKey
ALTER TABLE "HomePage" ADD CONSTRAINT "HomePage_subheroImageId_fkey" FOREIGN KEY ("subheroImageId") REFERENCES "File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HomeDirection" ADD CONSTRAINT "HomeDirection_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "ServiceCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AboutPage" ADD CONSTRAINT "AboutPage_heroImageId_fkey" FOREIGN KEY ("heroImageId") REFERENCES "File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
