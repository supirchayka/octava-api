...
async function seedCatalog() {
  const categories = [
    ...
    },
    {
      ...
      description: 'Процедуры для поддержания тонуса кожи и профилактики возрастных изменений.',
      gender: ServiceCategoryGender.MALE,
    },
    {
      name: 'Трихология для мужчин',
      slug: 'trihologiya-dlya-muzhchin',
      description: 'Диагностика и уход при выпадении волос и проблемах кожи головы.',
      gender: ServiceCategoryGender.MALE,
    },
  ];
  ...
  const services: ServiceSeed[] = [
    ...
    {
      categorySlug: 'muzhskaya-kosmetologiya',
      name: 'Комбинированная чистка лица для мужчин',
      slug: 'chistka-lica-muzhskaya',
      shortOffer: 'Глубокое очищение пор и выравнивание рельефа кожи.',
      priceFrom: '4800',
      durationMinutes: 60,
      benefit1: 'Снижает жирность и уменьшает воспаления.',
      benefit2: 'Освежает тон и улучшает текстуру кожи.',
      prices: [
        {
        ...
        {
          title: 'Чистка + успокаивающая маска',
          price: '6200',
          durationMinutes: 75,
          type: ServicePriceType.EXTRA,
          order: 2,
      ...
      indications: ['Комедоны и расширенные поры', 'Неровный рельеф кожи'],
      contraindications: ['Острые воспалительные высыпания', 'Свежий загар'],
      preparation: ['За сутки исключить агрессивные скрабы', 'Не бриться в день процедуры'],
      rehab: ['Избегать сауны и спортзала 2 дня', 'Использовать успокаивающий крем'],
      faq: [
        {
          question: 'Как часто можно делать чистку?',
          answer: 'В среднем раз в 4–6 недель, по рекомендации специалиста.',
        },
        {
          question: 'Будет ли покраснение?',
          answer: 'Лёгкое покраснение возможно первые сутки.',
        },
      ],
    },
    {
      categorySlug: 'muzhskaya-kosmetologiya',
      name: 'Антивозрастной уход для мужчин',
      slug: 'anti-age-uhod-muzhskoj',
      shortOffer: 'Уход с активными сыворотками для повышения тонуса и упругости.',
      priceFrom: '5300',
      durationMinutes: 50,
      benefit1: 'Поддерживает плотность кожи и уменьшает признаки усталости.',
      benefit2: 'Улучшает тон и микроциркуляцию.',
      prices: [
        {
          title: 'Стандартный уход',
          price: '5300',
          durationMinutes: 50,
          type: ServicePriceType.BASE,
          order: 1,
      ...
      indications: ['Снижение тонуса кожи', 'Тусклый цвет лица'],
      contraindications: ['Острые воспалительные процессы', 'Свежие повреждения кожи'],
      preparation: ['Не использовать ретиноиды за 2 дня', 'Сообщить о наличии аллергий'],
      rehab: ['Наносить SPF в течение 3 дней', 'Избегать перегрева кожи сутки'],
      faq: [
        {
          question: 'Сколько процедур нужно?',
          answer: 'Рекомендуется курс 4–6 процедур раз в 1–2 недели.',
        },
        {
          question: 'Можно ли делать после бритья?',
          answer: 'Желательно выдержать 24 часа после бритья.',
        },
      ],
    },
    {
      categorySlug: 'trihologiya-dlya-muzhchin',
      name: 'Консультация трихолога',
      slug: 'konsultaciya-trihologa',
      shortOffer: 'Диагностика кожи головы и план лечения выпадения волос.',
      priceFrom: '3500',
      durationMinutes: 40,
      benefit1: 'Определяет причины выпадения и подбирает терапию.',
      benefit2: 'Включает рекомендации по домашнему уходу.',
      prices: [
        {
      ...
      indications: ['Усиленное выпадение волос', 'Зуд и раздражение кожи головы'],
      contraindications: ['Острые инфекционные заболевания'],
      preparation: ['Не мыть голову за 12 часов', 'Подготовить список принимаемых препаратов'],
      rehab: ['Следовать назначенной схеме терапии'],
      faq: [
        {
          question: 'Нужны ли анализы?',
          answer: 'При необходимости врач назначит дополнительные исследования.',
        },
        {
          question: 'Когда ждать результат?',
          answer: 'Первые улучшения обычно заметны через 6–8 недель.',
        },
      ],
    },
    {
      ...
      slug: 'mezoterapiya-kozhi-golovy-m',
      shortOffer: 'Инъекционный курс для стимуляции роста волос.',
      priceFrom: '5900',
      durationMinutes: 45,
      benefit1: 'Усиливает питание волосяных фолликулов.',
      benefit2: 'Снижает выпадение и улучшает качество волос.',
      prices: [
        {
          title: 'Одна процедура',
          price: '5900',
      ...
      indications: ['Диффузное выпадение', 'Замедленный рост волос'],
      contraindications: ['Кожные инфекции', 'Беременность и лактация'],
      preparation: ['За сутки исключить алкоголь', 'Сообщить врачу о приёме антикоагулянтов'],
      rehab: ['Не мыть голову 12 часов', 'Избегать сауны 2 дня'],
      faq: [
        {
          question: 'Больно ли делать процедуру?',
          answer: 'Ощущения умеренные, возможно использование анестезии.',
        },
        {
          question: 'Какой интервал между процедурами?',
          answer: 'Обычно 7–10 дней, курсом 4–6 процедур.',
        },
      ],
    },
  ];
